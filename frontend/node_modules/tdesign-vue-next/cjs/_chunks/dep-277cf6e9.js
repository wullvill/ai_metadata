...
var number = require('./dep-8c1f583f.js');
var Vue = require('vue');
var throttle = require('./dep-eca8ae9d.js');
...
function useMirror() {
  var mirror = Vue.ref(MIRROR_DEFAULT);
...
function useScale(imageScale) {
  ...
  var lastZoomResult = Vue.ref({});
  var pinchDistance = 0;
  var doZoomIn = throttle.throttle(function (options) {
  ...
  var doZoomOut = throttle.throttle(function (options) {
  ...
  var onTouchStart = function onTouchStart(e) {
    ...
    var _Array$from = Array.from(e.touches),
      _Array$from2 = _slicedToArray__default["default"](_Array$from, 2),
  ...
  var onTouchMove = function onTouchMove(e) {
    ...
    var _Array$from3 = Array.from(e.touches),
      _Array$from4 = _slicedToArray__default["default"](_Array$from3, 2),
...
//# sourceMappingURL=dep-277cf6e9.js.map
